...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "flooring intelligence, flooring product tracking, carpet product tracking, flooring competitor monitoring, flooring market intelligence, flooring catalog updates, carpet supplier monitoring, flooring product scraper" },
      { name: "author", content: "FlooringIntel" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "FlooringIntel" },
